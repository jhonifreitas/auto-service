"""
Django settings for gojob project.
...
INSTALLED_APPS = [
    'gojob.core.apps.CoreConfig',
    'gojob.core.apps.SuitConfig',
...
EXTRA_APPS = [
    'gojob.core.apps.AuditlogCustomConfig',
...
PROJECT_APPS = [
    'gojob.customer.apps.CustomerConfig',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'gojob.core.context_processors.debug',
            ],
        },
    },
]

WSGI_APPLICATION = 'gojob.wsgi.application'
...
if DEFAULT_FILE_STORAGE == 'django.core.files.storage.FileSystemStorage':
    MEDIA_ROOT = config('MEDIA_ROOT', default=os.path.join(BASE_DIR, 'gojob/media'))
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'gojob.api.v1.auth.TokenAuthenticate',
    ),
    'DEFAULT_PERMISSION_CLASSES': (
        'gojob.api.v1.auth.IsUserAuthenticated',
    ),
