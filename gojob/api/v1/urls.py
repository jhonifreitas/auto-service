...
from gojob.api.v1.auth import views as auth_views
from gojob.api.v1.core import views as core_views
from gojob.api.v1.payment import views as payment_views
from gojob.api.v1.customer import views as customer_views
