...
from gojob.api.v1.payment import serializers
from gojob.api.v1.payment.pagseguro import Transcation
from gojob.api.v1.customer.serializers import ProfileSerializerRetrieve
    ...
    def pay(self, request):
        ...
        if serializer.is_valid():
            ...
            if not result.errors:
                ...
                profile.expiration = datetime.now() + timedelta(days=35)
                profile.save()
