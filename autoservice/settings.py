...
INSTALLED_APPS = [
    'autoservice.core.apps.CoreConfig',
    'autoservice.core.apps.SuitConfig',
...
EXTRA_APPS = [
    'autoservice.core.apps.AuditlogCustomConfig',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'autoservice.core.context_processors.debug',
            ],
        },
    },
]
...
if DEFAULT_FILE_STORAGE == 'django.core.files.storage.FileSystemStorage':
    MEDIA_ROOT = config('MEDIA_ROOT', default=os.path.join(BASE_DIR, 'autoservice/media'))
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'autoservice.api.v1.auth.TokenAuthenticate',
    ),
    'DEFAULT_PERMISSION_CLASSES': (
        'autoservice.api.v1.auth.IsUserAuthenticated',
    ),
